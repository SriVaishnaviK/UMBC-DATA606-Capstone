...
-  House Price Prediction(Kansas City)
...
- I plan to use various regression models such as linear regression, random forest, gradient boosting, XGBoost, Ridge Regressor, and Lasso Regressor, and compare their performance to choose the best model for predicting house prices
